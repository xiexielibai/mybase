...
map = {
    ...
    "Python-3.11.0.tar.xz": ("python3", "sh configure --prefix=/usr/local/python --enable-optimizations", False, True),
    ...
    "mysql-boost-5.7.39.tar.gz": ("mysql",
                                  ...
                                  False, True),
    "amazon-corretto-8.352.08.1-macosx-x64.tar.gz": ("jdk8",
    ...
    "corretto-11-11.0.17.8.1.tar.gz": (
        "jdk11", "sh configure --with-boot-jdk=../amazon-corretto-11.jdk/Contents/Home", False, False)
