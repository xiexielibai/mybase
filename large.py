...
map = {
    ...
    #                                  "sh configure --with-boot-jdk=../../jdk/amazon-corretto-8.jdk/Contents/Home --with-freetype-include=/usr/local/include/freetype2 --with-freetype-lib=/usr/local/lib",
    #                                  False, "make images"),

    # "corretto-11-11.0.17.8.1.tar.gz": (
    #     "jdk11", "sh configure --with-boot-jdk=../../jdk/amazon-corretto-11.jdk/Contents/Home", False, "make images"),

    "corretto-17-17.0.5.8.1.tar.gz": (
        "jdk17", "sh configure --with-boot-jdk=../../jdk/amazon-corretto-17.jdk/Contents/Home", False, "make images")
